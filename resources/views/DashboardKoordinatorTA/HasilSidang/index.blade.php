...
<div class="container">
    ...
    <div class="col-md-12 border p-3">
            ...
            @if(count($penilaianPenguji1) > 0)
                @php
                    $cth =  $penilaianPenguji1[0];
                @endphp
    ...
    <div class="col-md-12">
            ...
            @if(count($penilaianPenguji2) > 0)
                @php
                    $cth =  $penilaianPenguji2[0];
                @endphp
           <a href="{{route('generate.pdf', ['idTr'=>$cth->pdft_id, 'idUsn'=>$cth->png_username])}}">
               <button class="btn btn-primary" id="{{$cth->pdft_id}}">
                   Unduh Laporan
    ...
    <div class="col-md-12">
            ...
            @if(count($penilaianPenguji3) > 0)
                @php
                    $cth =  $penilaianPenguji3[0];
                @endphp
           <a href="{{route('generate.pdf', ['idTr'=>$cth->pdft_id, 'idUsn'=>$cth->png_username])}}">
               <button class="btn btn-primary" id="{{$cth->pdft_id}}">
                   Unduh Laporan
