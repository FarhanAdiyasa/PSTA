        ...
        <div id="accordions" role="tablist" aria-multiselectable="true">
            <div class="list-group">
                ...
                @if(Auth::guard('pengguna')->check())
                    ...
                    @elseif  (auth('pengguna')->user()->png_role == "Penguji")
       
                    <a href='{{route('DashboardPenguji.index')}}' class='list-group-item list-group-item-action' style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>
                        <i class='fa fa-home fa-lg fa-pull-left'></i>Dashboard
                    </a>
